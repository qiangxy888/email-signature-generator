    ...
    <main className="min-h-screen bg-gray-50">
      <div className="bg-gradient-to-br from-emerald-600 to-teal-700 text-white py-12 px-4">
        <div className="max-w-3xl mx-auto text-center">
          <h1 className="text-4xl font-bold mb-3">Free Email Signature Generator</h1>
          <p className="text-lg text-emerald-100">Create a professional email signature in minutes. Works with Gmail, Outlook & Apple Mail.</p>
        </div>
      </div>
